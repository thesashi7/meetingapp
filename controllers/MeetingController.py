...
class MeetingController():
    ...
    def acceptMeeting(self, meeting_att_id):
        ...
        message = attendee.username + " has accepted your request for meeting from " + str(
            meeting.start_time) + " to " + str(meeting.end_time)
    ...
    def declineMeeting(self, meeting_att_id):
        ...
        attendee = Employee.getById(meeting_att.employee_id)
        message = attendee.username + " has declined your request for meeting from " + str(
            meeting.start_time) + " to " + str(meeting.end_time)
